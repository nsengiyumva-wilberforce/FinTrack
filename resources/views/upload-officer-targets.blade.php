                ...
                <div class="col-lg-6">
                    <div class="card mb-4">
                        <div class="card-body px-4 pt-4 pb-2">
                            <h2 class="text-center mb-4">Upload officer Targets</h2>
                            <form id="uploadForm" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="officer_targets_file" class="form-label">Choose File:</label>
                                    <input type="file" name="officer_targets_file" id="file" class="form-control">
                                </div>
            ...
            $('#uploadForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        //redirect to officer-targets-uploader
                        window.location.href = '/officer-targets-uploader';
                    },
