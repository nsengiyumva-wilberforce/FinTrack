            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-body px-4 pt-4 pb-2">
                        <h2 class="text-center mb-4">Upload Written Off Customers</h2>
                        <form id="uploadForm" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="file" class="form-label">Choose File:</label>
                                <input type="file" name="upload_written_off_file" id="file" class="form-control">
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col">
                                    <a href="{{ url('truncate-written-offs') }}" class="btn btn-danger btn-block text-light" title="truncate">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#uploadForm').submit(function(event) {
                ...
                // AJAX request
                $.ajax({
                    url: '/upload-written-off-customers',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
