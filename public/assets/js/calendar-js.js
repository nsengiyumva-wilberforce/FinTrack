    ...
    document.addEventListener(
        ...
        function (e) {
            ...
            if (e.target.matches(".showEvent")) {
                ...
                document
                    .querySelectorAll(".showEvent")
                    .forEach((el) => el.classList.remove("active"));
                e.target.classList.add("active");
                let todaysDate =
                    e.target.textContent + " " + months[month] + " " + year;
                let eventDay =
                    days[new Date(year, month, e.target.textContent).getDay()];
                ...
                document
                    ...
                    .setAttribute("data-eventdate", eventDate);
